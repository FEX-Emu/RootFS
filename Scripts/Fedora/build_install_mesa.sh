...
git clone --depth=1 --branch libdrm-2.4.133 https://gitlab.freedesktop.org/mesa/drm.git
cd drm
...
git clone --depth=1 --branch mesa-26.2.0 https://gitlab.freedesktop.org/mesa/mesa.git
cd mesa
mkdir Build
mkdir Build_x86
